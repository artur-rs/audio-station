...
string TimeZoneData::decodeIcon(string a, bool synth)
{
    string str;
    if (a == clear_sky_d && !checkSunset())
        if (synth) str = ConstantsWeather::sunny.synthesable; else str = ConstantsWeather::sunny.printable;
    else if (a == clear_sky_n || (a == clear_sky_d && checkSunset()))
        if (synth) str = ConstantsWeather::clear_sky.synthesable; else str = ConstantsWeather::clear_sky.printable;
    else if (a == few_clouds_d || a == few_clouds_n || a == scatt_clouds_d || a == scatt_clouds_n)
        if (synth) str = ConstantsWeather::few_clouds.synthesable; else str = ConstantsWeather::few_clouds.printable;
    else if (a == rain_d || a == rain_n)
        if (synth) str = ConstantsWeather::rain.synthesable; else str = ConstantsWeather::rain.printable;
    else if (a == broken_clouds_d || a == broken_clouds_n)
        if (synth) str = ConstantsWeather::broken_clouds.synthesable; else str = ConstantsWeather::broken_clouds.printable;
    else if (a == shower_rain_d || a == shower_rain_n)
        if (synth) str = ConstantsWeather::shower_rain.synthesable; else str = ConstantsWeather::shower_rain.printable;
    else if (a == thunderstorm_d || a == thunderstorm_n)
        if (synth) str = ConstantsWeather::thunderstorm.synthesable; else str = ConstantsWeather::thunderstorm.printable;
    else if (a == snow_d || a == snow_n)
        if (synth) str = ConstantsWeather::snow.synthesable; else str = ConstantsWeather::snow.printable;
    else if (a == mist_d || a == mist_n)
        if (synth) str = ConstantsWeather::mist.synthesable; else str = ConstantsWeather::mist.printable;
